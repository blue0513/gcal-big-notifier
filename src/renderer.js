...
var fetchConfigJson = function () {
    var fileBody = fs.readFileSync(path.join(__dirname, "../config.Json"), "utf8");
...
var isTodayEvent = function (startTime) {
    var isCurrentDate = (0, moment_1["default"])(startTime).isSame(new Date(), "day");
...
var minutesBetween = function (since, until) {
    var duration = moment_1["default"].duration((0, moment_1["default"])(until).diff(since));
...
var setTimersAfterClear = function (events) {
    ...
    events.forEach(function (ev) {
        var minutes = minutesBetween(now, (0, moment_1["default"])(ev.start).toDate());
        var minutesFromNow = (minutes - notifyBeforeMin) * 60 * 1000;
        var title = ev.summary;
        var startTime = (0, moment_1["default"])(ev.start);
        notificationTimers.push(setTimeout(displaySchedule, minutesFromNow, title, startTime));
    });
};
...
function fetchEventsData(configJson) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].get(configJson["url"])];
                case 1:
                    response = _a.sent();
...
function main(configJson) {
    return __awaiter(this, void 0, void 0, function () {
        var eventsData, flattenEventsData, todayEvents, nextEvents, nextEvent, title;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchEventsData(configJson)];
                case 1:
                    eventsData = _a.sent();
                    ...
                    if (nextEvent) {
                        ...
                        displaySchedule(title, (0, moment_1["default"])(nextEvent.start).toDate());
                    }
                    else {
                        displaySchedule("All Schedule Finished", (0, moment_1["default"])().toDate());
                    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    console.log("fetchInterval: " + intervalMin + ", notifyBeforeMin: " + notifyBeforeMin);
                    main(configJson);
